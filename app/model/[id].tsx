  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: theme.background }]}>
      ...
      <KeyboardScroll ref={scrollRef} contentContainerStyle={styles.content}>
        ...
        <Section title="Generation defaults" description="When system messages are enabled, Sal’s built-in response and formatting instructions are included. A conversation may override these model defaults.">
          <Field label="Additional system instructions" value={draft.defaults.systemPrompt} onChangeText={(systemPrompt) => setDraft({ ...draft, defaults: { ...draft.defaults, systemPrompt } })} multiline placeholder="Optional model-specific behavior or personality" />
